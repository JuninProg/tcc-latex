...
\usepackage{pdfpages}			% Inclusão de arquivos PDF nos anexos
\usepackage{array}            % Colunas com largura fixa e alinhamentos personalizados
\usepackage{tabularx}        % Tabelas com colunas X adaptáveis
\usepackage{longtable}        % Tabelas que quebram em múltiplas páginas
% Pacotes para diagramas (fluxograma PRISMA)
\usepackage{tikz}
...
% ---
\titulo{Pró-Mamá em continuidade: reconstrução da plataforma web para apoio à saúde materno-infantil em Osório - RS}
...
% Capitulo 3
% ---
\include{elementos-textuais/capitulo-3-trabalhos-relacionados}
% ---
