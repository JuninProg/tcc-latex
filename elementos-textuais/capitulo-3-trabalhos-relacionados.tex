...
Após a seleção dos cinco estudos com maior pontuação, foi realizado a leitura dos textos completos, visando identificar aspectos funcionais, tecnológicos e metodológicos relevantes para a análise comparativa.

Dessa forma, produziu-se a Tabela \ref{tab:trabalhos_selecionados}, que sintetiza os principais elementos de cada trabalho, destacando suas contribuições e resultados.
...
\begin{tabular}{|p{3.0cm}|p{1.1cm}|p{8.9cm}|}
\hline
