...
\begin{itemize}
  ...
  \item Realizar a migração dos dados e arquivos retroativos garantindo integridade das informações;
  \item Implementar um processo de continuidade no ciclo de desenvolvimento de \emph{software}, estabelecendo práticas de entrega e integração contínua, além de testes automatizados para garantir a qualidade do sistema;
