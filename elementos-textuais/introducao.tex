...
Migrar tecnologicamente o painel administrativo e infraestrutura \emph{web} do Pró-Mamá para que os sistemas estejam de acordo com os requisitos de segurança e sejam restaurados, estabelecer um processo de continuidade no ciclo de desenvolvimento do \emph{software} e adicionar escalabilidade para que a plataforma possa ser utilizada por outros municípios.
