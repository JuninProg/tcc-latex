...
% TODO: arrumar citação com o título da reportagem
...
Migrar tecnologicamente o painel administrativo e infraestrutura \emph{web} do Pró-Mamá para que os sistemas estejam de acordo com os requisitos de segurança e sejam restabelecidos, estabelecer um processo de continuidade no ciclo de desenvolvimento do \emph{software} e adicionar escalabilidade para que a plataforma possa ser utilizada por outros municípios.
...
\begin{itemize}
  ...
  \item Implementar um processo de continuidade no ciclo de desenvolvimento do \emph{software}, estabelecendo práticas de entrega e integração contínua, além de testes automatizados para garantir a qualidade do sistema;
